...
## Practice Exercises {-}
1. (Least squares line)** No-fines concrete, made from a uniformly graded coarse aggregate and a cement-water paste, is beneficial in areas prone to excessive rainfall because of its excellent drainage properties. Researchers employed a least squares analysis in studying how y $X=$ porosity (%) is related to $Y=$ 5 unit weight (pcf) in concrete specimens. Consider the following representativedata:
...
SSE <- anova(mod)[2,2] # sum of residual^2
SST <- anova(mod)[1,2] + anova(mod)[2,2] 
c(SSE, SST)
```
