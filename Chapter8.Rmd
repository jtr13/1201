...
2. **(One sample test, Raw values)** We know that the mean sepal length of setosas (a species of irises) is 4.8 cm. A new study examines a sample of 50 flowers and shows that the sample mean is `mean(iris$Sepal.Length[1:50])` cm. Conduct a one-tailed hypothesis test at $.05$ significance level to show if there is sufficient evidence to reject the hypothesis that the mean of the new sample is equal to 4.8 cm.
