...
1. **(Standard Normal, `pnorm`)** A driver's reaction time for an in-traffic response to a brake signal can be modeled with a normal distribution having mean value 1.25 sec and standard deviation of .46 sec.  (Textbook 4.16)
...
2. **(Nonstandard Normal, `qnorm`)** Data collected from an experiment with a specified initial crack
...
3. **(Binom Appproximation)** Suppose that 25% of all students at a large public university receive financial aid. Let $X$ be the number of students in a random sample of size 50 who receive financial
