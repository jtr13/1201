...
3. **(Nonstandard Normal, `qnorm`)** Data collected from an experiment with a specified initial crack length propose a normal distribution with mean value 5.496 mm and standard deviation .067 mm. For this model, what value of final crack depth would be exceeded by only .5% of all cracks? (Textbook 4.18)
...
4. **(Binom Appproximation)** Suppose that 25% of all students at a large public university receive financial aid. Let $X$ be the number of students in a random sample of size 50 who receive financial aid, so that *p = .25*. What is the probability that at most 10 students receive aid? (Textbook 4.20)
